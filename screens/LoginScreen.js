...
export default function LoginScreen() {
    ...
    return (
        <SafeAreaView
            style={{display: "flex", justifyContent: "center", height: "100%", backgroundColor: colors.bg}}>
            <View
                style={{
                    padding: 10 * 2,
                }}
            >
                ...
                >
                    <AppTextInput placeholder="Email" onChangeText={(value) => updateEmail(value)}/>
                ...
                >
                    ...
                    >
                        Ainda não tem uma conta? <Text style={{color: colors.purple}}
